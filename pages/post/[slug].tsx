...
function Post({post}: Props) {
  ...
  return (
    <main>
        ...
        {submitted ? (
            <div className="flex flex-col p-10 bg-yellow-500 text-white
            max-w-2xl mx-auto">
                <h3 className="text-3xl font-bold">
                    thank you for submitting a comment
                </h3>
                <p>Once its approved will appear below!</p>
            </div>
        ) : (
            ...
            <label className="block mb-5">
                ...
                className="shadow border rounded py-2 px-3 form-input mt-1 block
                w-full ring-yellow-500 outline-none focus:ring" placeholder="John Apple" type="text" />
            </label>
            <label className="block mb-5">
                ...
                w-full ring-yellow-500 outline-none focus:ring" placeholder="John Apple" rows={8} />
            </label>
